      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full px-4 py-2 border ${errors.title ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            rows={4}
            className={`w-full px-4 py-2 border ${errors.review ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
