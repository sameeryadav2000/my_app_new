            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <span className="text-2xl font-bold tracking-wider text-black">MoboZen</span>
                </div>
                ...
                <div className="flex space-x-6">
                  ...
                  <button
                    onClick={() =>
                      openDialog(
                        "Terms of Service",
                        "By using the MoboZen website and services, you agree to these Terms of Service. These terms outline the rules for using our platform, purchasing policies, and your rights and responsibilities as a user.\n\nAll products sold by MoboZen are guaranteed to be fully functional and in the condition described. We verify the authenticity and quality of all devices before listing them for sale.\n\nPayment must be made in full before delivery of any product. We accept various payment methods including cash on delivery within Kathmandu Valley, bank transfers, and digital payment services like eSewa and Khalti."
                      )
                    }
                    className="text-xs text-gray-500 hover:text-black transition-colors duration-200"
                  >
