...
export default function Home() {
  ...
  return (
    <>
      <SEO
        title="Top Smartphones in Nepal - Latest Prices 2025 | MobileLoom"
        description="Find the latest iPhone, Samsung, Xiaomi, and Vivo phones in Nepal with updated prices. Compare specifications and features of popular smartphones available in Nepal."
        canonical="/"
